...
> **CF2 correction note:** review found that the first parser revision used LE header `+0x70` (`impmod_off`) as the enumerated-page base. Open Watcom establishes absolute `page_off @ +0x80`. The parser, fixtures and tests were corrected, all four pinned real targets were rerun, and the old disassembly/diff numbers were replaced rather than offset-adjusted. See [`docs/experiments/CF2-wdump-layout-correction.md`](./docs/experiments/CF2-wdump-layout-correction.md) and [`docs/experiments/CF2-real-target-regeneration.md`](./docs/experiments/CF2-real-target-regeneration.md). Do not copy the pre-correction CF2 numbers from git history or review comments.

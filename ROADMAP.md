...
- Open Watcom `wdump` independently matched `le_image.py info --json` on 24 shared LE header fields, both object records and every page row for all four pinned targets: 494 page rows total, zero disagreements;

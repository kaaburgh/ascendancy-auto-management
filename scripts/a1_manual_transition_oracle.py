...
def validate_record(record: dict[str, Any]) -> dict[str, Any]:
    ...
    if coverage.get("all_relevant_zero_write_paths_established") is not True and coverage.get("equivalent_lossless_boundary_established") is not True:
        raise A1ManualInvalidationError(
            "positive outcome requires all relevant zero-write paths or an equivalent lossless boundary"
        )
